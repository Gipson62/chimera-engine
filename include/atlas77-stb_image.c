...
{
    return (stbi_stbi_uc *)(stbi_load_from_memory((stbi_uc *)buffer, len, x, y, channels_in_file, desired_channels));
}
...
{
    return (stbi_stbi_uc *)(stbi_load_from_callbacks((stbi_io_callbacks *)clbk, user, x, y, channels_in_file, desired_channels));
}

extern stbi_stbi_uc *stbi_stbi_load(char const *filename, int *x, int *y, int *channels_in_file, int desired_channels)
{
    return (stbi_stbi_uc *)(stbi_load(filename, x, y, channels_in_file, desired_channels));
}

extern stbi_stbi_uc *stbi_stbi_load_from_file(FILE *f, int *x, int *y, int *channels_in_file, int desired_channels)
{
    return (stbi_stbi_uc *)(stbi_load_from_file(f, x, y, channels_in_file, desired_channels));
}
...
{
    return (stbi_stbi_uc *)(stbi_load_gif_from_memory((stbi_uc *)buffer, len, delays, x, y, z, comp, req_comp));
}
...
{
    return (stbi_stbi_us *)(stbi_load_16_from_memory((stbi_uc *)buffer, len, x, y, channels_in_file, desired_channels));
}
...
{
    return (stbi_stbi_us *)(stbi_load_16_from_callbacks((stbi_io_callbacks *)clbk, user, x, y, channels_in_file, desired_channels));
}

extern stbi_stbi_us *stbi_stbi_load_16(char const *filename, int *x, int *y, int *channels_in_file, int desired_channels)
{
    return (stbi_stbi_us *)(stbi_load_16(filename, x, y, channels_in_file, desired_channels));
}

extern stbi_stbi_us *stbi_stbi_load_from_file_16(FILE *f, int *x, int *y, int *channels_in_file, int desired_channels)
{
    return (stbi_stbi_us *)(stbi_load_from_file_16(f, x, y, channels_in_file, desired_channels));
}
